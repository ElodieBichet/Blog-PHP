<form action="index.php?controller=page&task=send" method="POST">
    <div class="row">
        ...
        <div class="col-lg-4 col-md-6">
            <div class="form-floating mb-3">
                <input type="email" class="form-control" name="sender_email_address" id="sender_email_address" placeholder="Adresse email" value="<?= ($isConnected) ? filter_var($sessionTab['user_email'], FILTER_SANITIZE_EMAIL) : '' ?>">
